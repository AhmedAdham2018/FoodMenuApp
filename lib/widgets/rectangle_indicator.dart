...
class RectangleIndicator extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _RectangleIndicatorState(
  ...
  static RectangleIndicator get(
    ...
    return RectangleIndicator(pagerController, indicator.size, indicator.radius,
        indicator.baseColor, indicator.selectedColor);
  }
}
